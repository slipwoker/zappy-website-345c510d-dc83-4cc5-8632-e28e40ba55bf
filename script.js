document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    if (field.hasAttribute('maxlength')) {
      ...
      if (value.length > max) {
        showFieldError(field, field.dataset.errorMaxlength || 'Maximum ' + max + ' characters allowed.');
        return false;
      }
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '345c510d-dc83-4cc5-8632-e28e40ba55bf',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '345c510d-dc83-4cc5-8632-e28e40ba55bf';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '345c510d-dc83-4cc5-8632-e28e40ba55bf';
